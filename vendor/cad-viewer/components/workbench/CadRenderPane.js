...
export default function CadRenderPane({
  ...
  suppressTopologySelectionUnavailableAlert = false,
  ...
  const showTopologySelectionUnavailableAlert = topologySelectionUnavailable && !suppressTopologySelectionUnavailableAlert;
    ...
    <div className="absolute inset-0">
      {dxfMode && !dxfMeshPreviewReady ? (
        ...
        <CadExplorer
          ...
          orbitPreviewActive={dxfMode ? false : orbitPreviewActive}
      ...
      {!previewMode && !stepUpdateInProgress && showTopologySelectionUnavailableAlert ? (
        <div className="pointer-events-none absolute z-20 flex justify-center px-4" style={modelViewportBottomOverlayStyle}>
          <Alert
            role="status"
            variant="warning"
