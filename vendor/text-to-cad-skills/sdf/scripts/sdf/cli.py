...
from sdf.preview import write_preview_sidecar_if_needed
...
def _generate_target(script_path: Path, *, output_path: Path, gz_check: str, strict: bool) -> Path:
    ...
    preview_path = write_preview_sidecar_if_needed(xml_text, output_path=output_path)
    if preview_path is not None:
        print(f"Wrote SDF preview: {preview_path}")
