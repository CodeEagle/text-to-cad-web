...
- confirm simulator-only metadata is either listed as static metadata in direct Explorer review or suppressed in an internal `<stem>.viewer.sdf` preview sidecar;
